...
def simple_message_exception_handler(exctype, value: BaseException, traceback: TracebackType):
    ...
    args:
      # TODO(aaronatp): Once capa drops support for Python 3.8, move the exctype type annotation to the
      # function parameters and remove the "# type: ignore[incompatible-types]" from the relevant place
...
def main(argv: Optional[List[str]] = None):
    ...
    if not args.debug:
        sys.excepthook = simple_message_exception_handler  # type: ignore[incompatible-types]
