...
If you use Ghidra, then you can use the [Ghidra Backend](/capa/ghidra/). capa will extract features directly from your Ghidra databases and help you identify the functionality of the programs that you import or are already working on. 
