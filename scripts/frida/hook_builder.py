...
def load_apk_meta():
    """Load APK meta information generated by apk_meta_extractor.py"""
    try:
        ...
        if not meta_file.exists():
            print(f"No APK meta file found: {meta_file}")
            return None
        ...
        print(f"Failed to load APK meta: {e}")
...
def build_frida_script(apis_file_path: Path, output_file_path: Path, jsonl_filename: str):
    ...
    apk_meta = load_apk_meta()
    if not apk_meta:
        raise ValueError("Cannot generate script without APK meta")
